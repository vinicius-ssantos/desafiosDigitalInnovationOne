package digital.innovation.one.desafios.java.ResolvendoAlgoritmosComJava._4HashMágico;

public class Main {
}
/*
Desafio
O conceito de hash é transformar uma grande quantidade de dados em uma pequena quantidade
de informações. Nesse algoritmo você terá uma entrada com várias linhas, cada uma com uma
string.
...
As posições iniciam em zero. 'A' tem posição 0 no alfabeto, ‘C' tem posição 2 no
